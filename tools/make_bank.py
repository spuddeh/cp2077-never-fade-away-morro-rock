r"""Build a soundbank that plays a file the game already ships as a radio station track.
...
SHIPPED = ("mus_radio_01_att_rock_never_fade_away_cover", 1067066079, 540.0, 2100.0, 845273388)
